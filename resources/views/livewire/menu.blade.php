    ...
    <div class="px-5">
        <div class="categories">
            @foreach ($categories as $category)
                <div class="category">
                    <div
                        class="text-start font-bold mr-1  mb-1 text-[#2c4d41] text-xl font-bold mt-5">{{ $category->name }}</div>
...
{{--                                            <span class="mt-0.5 text-gray-100 text-xs block">--}}
                                        ...
                                        <span
                                            class="w-full inline-block text-end">{{ number_format($menuItem->price) }}
                                            تومان
                                        </span>
                                    </div>
                                </div>
